...
function Signup() {
  ...
  const handleSubmit = async(e) =>{
    ...
    try {
      ...
      console.log('await is here',await signUp(email,password))
      console.log('sign up successfll');
      navigate('/')
    } catch (error) {
        ...
        <div className="w-full fixed px-4 py-24 z-50">
          <div className="max-w-[450px] h-[600px] mx-auto bg-black/75 text-white">
            <div className="max-w-[320px] mx-auto py-16">
              ...
              <form className="w-full flex flex-col py-4" action="" onSubmit={handleSubmit}>
                <input
